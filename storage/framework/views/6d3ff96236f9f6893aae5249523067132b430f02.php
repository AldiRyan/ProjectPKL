...
<!-- Primary Meta Tags -->
<meta name="description" content="<?php echo e($general->meta_desc); ?>">
<meta name="keywords" content="<?php echo e($general->keyword); ?>">
<!-- Open Graph / Facebook -->
<meta property="og:type" content="website">
<meta property="og:url" content="127.0.0.1:8000">
<meta property="og:title" content="<?php echo e($general->title); ?>">
<meta property="og:description" content="<?php echo e($general->meta_desc); ?>">
<meta property="og:image" content="<?php echo e(asset('storage/'.$general->favicon)); ?>">

<!-- Twitter -->
<meta property="twitter:card" content="summary_large_image">
<meta property="twitter:url" content="127.0.0.1:8000">
<meta property="twitter:title" content="<?php echo e($general->title); ?>">
<meta property="twitter:description" content="<?php echo e($general->meta_desc); ?>">
<meta property="twitter:image" content="<?php echo e(asset('storage/'.$general->favicon)); ?>">
...
<?php $__env->startSection('content'); ?>
  ...
  <section id="hero">
    <div id="heroCarousel" class="carousel slide carousel-fade" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        ...
        <div class="carousel-item <?php echo e($key == 0 ? 'active' : ''); ?>" style="background-image: url(<?php echo e(asset('storage/'.$banner->cover)); ?>);">
          <div class="carousel-container">
            <div class="carousel-content animate__animated animate__fadeInUp">
              ...
              <div class="text-center">
                <a href="<?php echo e($banner->link); ?>" class="btn-get-started">Read More</a>
              </div>
              <?php endif; ?>
            </div>
          </div>
  ...
  <main id="main">
    ...
    <section id="Profil-Perusahaan" class="Profil-Perusahaan">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Profil Perusahaan</strong></h2>
        </div>
    ...
    </section><!-- End Profil perusahaan Section -->
        ...
        <div class="row">
          ...
          <?php $__currentLoopData = $service; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              ...
              <div class="icon-box iconbox-blue">
                ...
                <h4><a href="<?php echo e(route('serviceshow',$service->slug)); ?>"><?php echo e($service->title); ?></a></h4>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\pt_bosto\profile-bosto\resources\views/front/home.blade.php ENDPATH**/ ?>