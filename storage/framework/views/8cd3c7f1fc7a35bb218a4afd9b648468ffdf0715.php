      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          ...
          <li class="drop-down"><a href="">About</a>
            <ul>
              <li <?php echo e(request()->is('profile-perusahaan') ? 'class=active' : ''); ?>><a href="<?php echo e(route('about')); ?>">Profile Perusahaan</a></li>
              <li <?php echo e(request()->is('visi-misi') ? 'class=active' : ''); ?>><a href="<?php echo e(route('testi')); ?>">Visi Misi</a></li>
            </ul>
          </li>

          <li <?php echo e(request()->is('services') ? 'class=active' : ''); ?>><a href="<?php echo e(route('service')); ?>">Services</a></li>
          <li <?php echo e(request()->is('portfolio') ? 'class=active' : ''); ?>><a href="<?php echo e(route('portfolio')); ?>">Portfolio</a></li>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            ...
            <p>
              ...
              <?php echo e($general->address2); ?><br>
              <a href="<?php echo e($general->gmaps); ?>" target="_blank" rel="noopener noreferrer">(Go to gmaps)</a>
              <br><br>
              
              <strong>Phone:</strong> <?php echo e($general->phone); ?><br>
              <strong>Email:</strong> <?php echo e($general->email); ?><br>
            </p>
          </div>
...
<?php /**PATH E:\pt_bosto\profile-bosto\resources\views/layouts/front.blade.php ENDPATH**/ ?>