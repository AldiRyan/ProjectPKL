    ...
    <ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="<?php echo e(route('admin.portfolio')); ?>">Produk</a>
            <a class="collapse-item" href="<?php echo e(route('admin.pcategory')); ?>">Kategori Produk</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="<?php echo e(route('admin.about')); ?>">Tentang</a>
            <a class="collapse-item" href="<?php echo e(route('admin.banner')); ?>">Carousel</a>
            <a class="collapse-item" href="<?php echo e(route('admin.general')); ?>">Pengaturan Umum</a>
          </div>
        </div>
      </li>
